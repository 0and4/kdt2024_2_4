    ...
    public void initialize() {
        ...
        confirmButton.setOnMouseClicked(e->{
            ...
            try {
            	...
            	if((Integer)jsonMap.get("statusCode") == StatusCode.SUCCESS.getStatusCode()) {
					...
					FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/PointUsingSuccessPopup.fxml"));
        ...
        phoneField.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (phoneField.getText().matches("010-\\d{4}-\\d{4}")) {
            	System.out.println("형식 일치 O");
                confirmButton.setDisable(false); // 형식이 맞으면 버튼 활성화
            } else {
            	System.out.println("형식 일치 X");
